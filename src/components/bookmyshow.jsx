...
const Bookmyshow = () => {
    return ( 
        ...
        <div class="content2">
            <div class="section">
                <img src="https://assets-in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:oi-discovery-catalog@@icons@@like_202006280402.png,ox-24,oy-617,ow-29:ote-MjQ2LjJLIGxpa2Vz,ots-29,otc-FFFFFF,oy-612,ox-70:q-80/et00348725-grqrbbqnrs-portrait.jpg" alt="" />
                <h3>Ponniyin Selvan - Part 2</h3>
                <p>Action/Adventure/Drama /Historical</p>
            </div>
            <div class="section">
